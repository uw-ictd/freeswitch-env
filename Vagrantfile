...
Vagrant.configure(2) do |config|
  ...
  config.vm.define :fsbuild, autostart: true do |machine|
    machine.vm.box = "debian/contrib-jessie64"
    machine.vm.hostname = "fsbuild"
    machine.vm.synced_folder "./" , "/home/vagrant/freeswitch-env", type: "virtualbox"
    ...
    machine.vm.provision "ansible" do |ansible|
      ...
      ansible.playbook = "ansible/freeswitch-build-env.yml"
